<%@ Page Title="" Language="C#" MasterPageFile="~/Default/MasterPage.master" AutoEventWireup="true" CodeFile="ACC_GNTransactionList.aspx.cs" Inherits="AdminPanel_Account_ACC_GNTransaction_ACC_GNTranscationList" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="cphPageHeader" runat="Server">
    <asp:Label ID="lblPageHeader_XXXXX" runat="server" Text="GNTransaction"></asp:Label>
    <small>
                                                    ...
                                                    <ItemTemplate>
                                                        ...
                                                        <tr class="odd gradeX">
                                                            ...
                                                            <td class="text-center">
                                                                <%#Eval("Date", GNForm3C.CV.DefaultDateSQLFormatForGrid) %>
                                                            </td>
                                                            <td>
                                                                <%#Eval("DateOfAdmission", GNForm3C.CV.DefaultDateSQLFormatForGrid) %>
                                                            </td>
                                                            <td>
                                                                <%#Eval("DateOfDischarge", GNForm3C.CV.DefaultDateSQLFormatForGrid) %>
                                                            </td>
                                                            <td>
                                                                <%#Eval("Deposite") %>
                                                            </td>
