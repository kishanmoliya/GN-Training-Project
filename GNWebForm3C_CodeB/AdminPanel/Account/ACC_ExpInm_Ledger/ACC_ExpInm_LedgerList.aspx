                    ...
                    <div class="portlet light">
                        ...
                        <div class="portlet-body">
                            <div class="row" runat="server" id="Div_SearchResult" visible="false">
                                <div class="col-md-12">
                                    <div id="TableContent">
                                        <table class="table table-bordered-black table-advanced table-striped" id="sample_1">
                                            <%-- Table Header --%>
                                            <thead>
                                                <tr class="TRDark row">
                                                    <th class="text-center col-md-4">
                                                        <asp:Label ID="lbhDate" runat="server" Text="Date" Style="font-weight: bold;"></asp:Label>
                                                    </th>

                                                    <th class="text-center col-md-4">
                                                        <asp:Label ID="lbhType" runat="server" Text="Type <br/>(Income/Expense)" Style="font-weight: bold;"></asp:Label>
                                                    </th>

                                                    <th class="text-right col-md-4">
                                                        <asp:Label ID="lbhAmount" runat="server" Text="Amount" Style="font-weight: bold;"></asp:Label>
                                                    </th>

                                                    <th class="text-left col-md-4">
                                                        <asp:Label ID="lbhNote" runat="server" Text="Note" Style="font-weight: bold;"></asp:Label>
                                                    </th>
                                                </tr>
                                            </thead>
                                            <%-- END Table Header --%>
                                            ...
                                            <tbody>
                                                <asp:Repeater ID="rpData" runat="server" OnItemCommand="rpData_ItemCommand">
                                                    <ItemTemplate>
                                                        ...
                                                        <tr class="odd gradeX row" style='<%# Eval("LedgerType").ToString() == "Income" ? "background-color: lightgreen;": "background-color: red;" %>'>
                                                            <td class="text-center col-md-4"><%#Eval("LedgerDate", GNForm3C.CV.DefaultDateFormatForGrid) %>
                                                            </td>

                                                            <td class="text-center col-md-4"><%#Eval("LedgerType") %>
                                                            </td>

                                                            <td class="text-right col-md-4"><%#Eval("LedgerAmount", GNForm3C.CV.DefaultCurrencyFormatWithDecimalPoint) %>
                                                            </td>

                                                            <td class="text-left col-md-4"><%#Eval("LedgerNote") %>
                                                            </td>
                                                        </tr>
                                                        <%-- END Table Rows --%>
                                                    </ItemTemplate>
                                                ...
                                                <tr class="row text-right">
                                                    <td class="col-md-4" colspan="2">
                                                        <h6 style="font-weight: bold;">Total Balance</h6>
                                                    </td>
                                                    <td class="col-md-4">
                                                        <asp:Label ID="txtTotalBalance" runat="server" Style="font-weight: bold;"></asp:Label>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
