                        ...
                        <div class="portlet-title">
                            ...
                            <div class="tools">
                                <div>
                                    ...
                                    <asp:HyperLink SkinID="hlAddMany" ID="hlAddManyXML" NavigateUrl="~/AdminPanel/Account/ACC_Income/ACC_IncomeAddEditManyXML.aspx" runat="server"></asp:HyperLink>
                                    ...
                                    <div id="TableContent">
                                        <table class="table table-bordered table-advanced table-striped table-hover" id="sample_1">
                                            ...
                                            <thead>
                                                <tr class="TRDark">
                                                    <th>
                                                        <asp:Label ID="lblIsSelected" runat="server" Text="Delete Many"></asp:Label>
                                                    </th>
                                                    <th>
                                            ...
                                            <tbody>
                                                <asp:Repeater ID="rpData" runat="server" OnItemCommand="rpData_ItemCommand">
                                                    <ItemTemplate>
                                                        ...
                                                        <tr class="odd gradeX">
                                                            <th>
                                                                <asp:CheckBox ID="chkIsSelectated" runat="server" />
                                                                <asp:HiddenField ID="hfIncomeID" runat="server" Value='<%#Eval("IncomeID") %>' />
                                                            </th>
                                                            <td>
