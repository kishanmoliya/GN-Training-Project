<%@ Page Title="" Language="C#" MasterPageFile="~/Default/MasterPage.master" AutoEventWireup="true" CodeFile="EMP_EmployeeDetailsAddEditMore.aspx.cs" Inherits="AdminPanel_Employee_EMP_EmployeeDetails_EMP_EmployeeDetailsAddEditMore" %>
...
<asp:Content ID="cntBreadcrumb" ContentPlaceHolderID="cphBreadcrumb" runat="Server">
    ...
    <li class="active">
        <asp:Label ID="lblBreadCrumbLast" runat="server" Text="Employee Details Add/Edit More"></asp:Label>
    </li>
</asp:Content>
<asp:Content ID="cntPageContent" ContentPlaceHolderID="cphPageContent" runat="Server">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional" ChildrenAsTriggers="false">
        <ContentTemplate>
            ...
            <asp:UpdatePanel ID="upEMP_EmployeeDetails" runat="server" EnableViewState="true" UpdateMode="Always">
                <Triggers>
                </Triggers>
                <ContentTemplate>
                    <div class="row">
                                ...
                                <div class="form-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-3 text-start">
                                            <label class=" control-label">
                                                <span class="required">*</span>
                                                <asp:Label ID="lblHospitalID_XXXXX" runat="server" Text="EmployeeType Name"></asp:Label>
                                            </label>
                                        </div>
                                        <div class="col-md-3 text-start">
                                            <label class=" control-label">
                                                <asp:Label ID="lblRemarks_XXXXX" runat="server" Text="Remark"></asp:Label>
                                            </label>
                                        </div>
                                    </div>
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <asp:TextBox ID="txtRemark" runat="server" CssClass="form-control" PlaceHolder="Enter Remarks"></asp:TextBox>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                                ...
                                                <table id="sample_1" class="table table-bordered table-advanced table-striped table-hover">
                                                    ...
                                                    <thead>
                                                        <tr class="TRDark">
                                                            ...
                                                            <th>
                                                                <asp:Label ID="lbhEmployeeID" runat="server" Text="Employee Name"></asp:Label>
                                                            </th>
                                                            <th>
                                                        ...
                                                        <asp:Repeater ID="rpData" runat="server" OnItemCommand="rpData_ItemCommand">
                                                            <ItemTemplate>
                                                                ...
                                                                <tr class="odd gradeX">
                                                                    ...
                                                                    <td>
                                                                        <asp:Label ID="lblEmployeeTypeName" runat="server" Text='<%#Eval("EmployeeTypeName") %>'></asp:Label>
                                            ...
                                            <div runat="server" class="form-actions">
                                                <div class="row">
                                                    <div class="col-md-offset-3 col-md-9">
                                                        ...
                                                        <asp:HyperLink ID="hlCancel" runat="server" NavigateUrl="~/AdminPanel/Employee/EMP_EmployeeDetails/EMP_EmployeeDetailsList.aspx" SkinID="hlCancel"></asp:HyperLink>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
