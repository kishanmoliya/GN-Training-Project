...
<asp:Content ID="Content2" ContentPlaceHolderID="cphPageHeader" runat="Server">
    ...
    <small>
        <asp:Label ID="lblPageHeaderInfo_XXXXX" runat="server" Text="Details"></asp:Label></small>
...
<asp:Content ID="Content3" ContentPlaceHolderID="cphBreadcrumb" runat="Server">
    ...
    <li class="active">
        <asp:Label ID="lblBreadCrumbLast" runat="server" Text="EmployeeDetails"></asp:Label>
    </li>
</asp:Content>
                        ...
                        <div class="portlet-title">
                            ...
                            <div class="tools">
                                <div>
                                    ...
                                    <asp:HyperLink SkinID="hlAddNew" ID="hlAddNew" NavigateUrl="~/AdminPanel/Employee/EMP_EmployeeDetails/EMP_EmployeeDetailsAddEdit.aspx" runat="server"></asp:HyperLink>
                                        ...
                                        <table class="table table-bordered table-advanced table-striped table-hover" id="sample_1">
                                            ...
                                            <thead>
                                                <tr class="TRDark">
                                                    ...
                                                    <th>
                                                        <asp:Label ID="lbhEmployeeType" runat="server" Text="EmployeeType"></asp:Label>
                                                    </th>
                                            ...
                                            <tbody>
                                                <asp:Repeater ID="rpData" runat="server" OnItemCommand="rpData_ItemCommand">
                                                    <ItemTemplate>
                                                        ...
                                                        <tr class="odd gradeX">
                                                            <td>
                                                                <asp:HyperLink ID="hlViewExpenseTypeID" NavigateUrl='<%# "~/AdminPanel/Employee/EMP_EmployeeDetails/EMP_EmployeeDetailsView.aspx?EmployeeID=" + GNForm3C.CommonFunctions.EncryptBase64(Eval("EmployeeID").ToString()) %>' data-target="#viewiFrameReg" CssClass="modalButton" data-toggle="modal" runat="server"><%#Eval("EmployeeName") %></asp:HyperLink>
                                                            </td>
                                                            <td>
                                                                <%#Eval("EmployeeTypeName") %>
                                                            </td>
                                                            <td class="text-nowrap text-center">
                                                                <asp:HyperLink ID="hlView" SkinID="View" NavigateUrl='<%# "~/AdminPanel/Employee/EMP_EmployeeDetails/EMP_EmployeeDetailsView.aspx?EmployeeID=" + GNForm3C.CommonFunctions.EncryptBase64(Eval("EmployeeID").ToString()) %>' data-target="#viewiFrameReg" data-toggle="modal" runat="server"></asp:HyperLink>
                                                                <asp:HyperLink ID="hlEdit" SkinID="Edit" NavigateUrl='<%# "~/AdminPanel/Employee/EMP_EmployeeDetails/EMP_EmployeeDetailsAddEdit.aspx?EmployeeID=" + GNForm3C.CommonFunctions.EncryptBase64(Eval("EmployeeID").ToString()) %>' runat="server"></asp:HyperLink>
