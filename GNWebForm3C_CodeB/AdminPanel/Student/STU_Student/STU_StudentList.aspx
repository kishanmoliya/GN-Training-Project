...
<asp:Content ID="Content3" ContentPlaceHolderID="cphBreadcrumb" runat="Server">
    ...
    <li class="active">
        <asp:Label ID="lblBreadCrumbLast" runat="server" Text="StudentList"></asp:Label>
    </li>
</asp:Content>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <asp:DropDownList ID="ddlCurrentSem" CssClass="First form-control select2me" runat="server"></asp:DropDownList>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <asp:TextBox ID="txtEmailPersonal" CssClass="First form-control" runat="server" PlaceHolder="Enter Personal Email"></asp:TextBox>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <asp:DropDownList ID="ddlGender" CssClass="First form-control select2me" runat="server"></asp:DropDownList>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="portlet-title">
                            ...
                            <div class="tools">
                                <div>
                                    ...
                                    <asp:HyperLink ID="hlAddEditPopUp" SkinID="View" NavigateUrl="~/AdminPanel/Student/STU_Student/STU_StudentAddEditPopUp.aspx" data-target="#viewiFrameReg" data-toggle="modal" runat="server"></asp:HyperLink>
                                        ...
                                        <table class="table table-bordered table-advanced table-striped table-hover" id="sample_1">
                                            ...
                                            <thead>
                                                <tr class="TRDark">
                                                    ...
                                                    <th>
                                                        <asp:Label ID="EmailStudent" runat="server" Text="Email"></asp:Label>
                                                    </th>
                                                    <th style="text-align: right">
                                                        <asp:Label ID="EnrollmentNo" runat="server" Text="Enrollment No."></asp:Label>
                                                    </th>
                                                    <th style="text-align: right">
                                                        <asp:Label ID="CurrentSem" runat="server" Text="Current Semester"></asp:Label>
                                                    </th>
                                            ...
                                            <tbody>
                                                <asp:Repeater ID="rpData" runat="server" OnItemCommand="rpData_ItemCommand">
                                                    <ItemTemplate>
                                                        ...
                                                        <tr class="odd gradeX">
                                                            <td>
                                                                <asp:HyperLink ID="hlViewStudentID" NavigateUrl='<%# "~/AdminPanel/Employee/EMP_EmployeeDetails/EMP_EmployeeDetailsView.aspx?StudentID=" + GNForm3C.CommonFunctions.EncryptBase64(Eval("StudentID").ToString()) %>' data-target="#viewiFrameReg" CssClass="modalButton" data-toggle="modal" runat="server"><%#Eval("StudentName") %></asp:HyperLink>
                                                            </td>
                                                            <td>
                                                                <%#Eval("EmailPersonal") %>
                                                            </td>
                                                            ...
                                                            <td class="text-nowrap text-center">
                                                                ...
                                                                <asp:HyperLink ID="hlPopUpEdit" SkinID="ViewPopUp" NavigateUrl='<%# "~/AdminPanel/Student/STU_Student/STU_StudentAddEditPopUp.aspx?StudentID=" + GNForm3C.CommonFunctions.EncryptBase64(Eval("StudentID").ToString()) %>' data-target="#viewiFrameReg" data-toggle="modal" runat="server"></asp:HyperLink>
