...
public partial class AdminPanel_Student_STU_Student_STU_StudentList : System.Web.UI.Page
{
    ...
    private void Search(int PageNo)
    {
        ...
        if (Request.QueryString["StudentID"] != null)
        {
            if (!Page.IsPostBack)
            {
                StudentID = CommonFunctions.DecryptBase64Int32(Request.QueryString["StudentID"]);
            }
            else
            {
        ...
        DataTable dt = balSTU_Student.SelectPage(Offset, PageRecordSize, out TotalRecords, StudentName, EnrollmentNo, CurrentSem, EmailInstitute, EmailPersonal, Gender, ContactNo, RollNo);
