...
public partial class AdminPanel_DataTree_HospitalDataTree_IncomeDataTree : System.Web.UI.Page
{
    ...
    //    MST_HospitalBAL balIncomeDataTree = new MST_HospitalBAL();
    //    DataTable dtMST_Hospital = balIncomeDataTree.SelectPage(Offset, PageRecordSize, out TotalReceivedRecord, Hospital, PrintName, PrintLine1, PrintLine2, PrintLine3, FooterName, ReportHeaderName);
